			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button id='delModalBtn' id="delModalBtn" class="btn btn-danger">삭제</button>
						<button id='modalBtn' id="modalBtn" class="btn btn-info">등록</button>
...
<center>
   ...
   <table>
     <tr>
     <img src="/resources/images/menu_todie.PNG" alt="토다이정보"/>
     </tr>
   </table>
   </main>
</center>
...
<a href="todieMapView"><button type="button" class="button2" id="mapBtn">지도보기</button> 
</a>
