...
<div id="content">
	<div class="inner">
    	<article class="box post post-excerpt">
			...
			<form action="reply" method="post" class="container" onsubmit="return writeSave()">
				...
				<tr>
					<td colspan="2"><input type="submit" value="답변" class="btn btn-success">&nbsp;&nbsp;<input type="reset" value="초기화" class="btn">&nbsp;&nbsp;
					<a href="list"><button type="button" class="btn btn-warning">목록</button></a></td>
				</tr>
			</table>
		</form> 	
